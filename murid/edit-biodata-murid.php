    ...
    if ($foto_size > 2097152) {
       ...
       if ($foto_nama != "") {
          ...
          if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            if($query){
            	header("location:biodata-murid.php?pesan=berhasil");
            } else {
                header("location:biodata-murid.php?pesan=gagal");
            }

            } else { 
                // Jika ekstensinya tidak sesuai dengan apa yg kita tetapkan maka error
                header("location:biodata-murid.php?pesan=ekstensi");        }
